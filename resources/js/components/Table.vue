    ...
    <div class="">
        ...
        <table class="table align-middle mb-0 bg-white">
            ...
            <tr v-for="(email,index) in emails" v-bind:key="email.id">
                ...
                <td>
                    <router-link :to="{name:'recipient.emails',params:{email:email.to_email} }" exact class="link2">
                        {{ email.to_email }}
                    </router-link>
                </td>
                <td>
                ...
                <td v-else-if="email.status == 'Posted'">
                    <span class="badge badge-warning rounded-pill d-inline">Posted</span>
                </td>
                <td v-else>
                    <span class="badge badge-danger rounded-pill d-inline">Failed</span>
                </td>

                <td>
                    <router-link :to="{name:'email.show',params:{id:email.id} }" exact class="view-link"><i
